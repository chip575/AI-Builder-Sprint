      ...
      <div className={SECTION_STACK}>
        ...
        <section className={SECTION_PANEL}>
          <SectionHeading
            ...
            <br />
            <strong>쓰는 법</strong> — 회상 대화에서 이야기를 나누시면 문단이 만들어지고, 그중 남기실 것만 고르시면 여기에 보관됩니다.
              </>
            }
          />
        ...
        <section className={SECTION_PANEL}>
          <div className="flex items-center justify-between">
            ...
            <br />
            <strong>쓰는 법</strong> — 그날이 되면 파란 칸으로 올라옵니다. 눌러서 그대로 두실지 바꾸실지 정하시면 됩니다. 아직 먼 약속은 흰 칸에 있습니다. 시연에서는 “시간을 6개월 당겨보기”로 그 순간을 앞당겨 보실 수 있습니다.
              </>
            }
          />
        ...
        <section className={SECTION_PANEL}>
          <SectionHeading
            ...
            <br />
            <strong>쓰는 법</strong> — 줄을 누르면 그 서류로 갑니다. 서명 전이면 이어서 쓰는 화면으로, 서명이 끝났으면 증빙 화면으로 열립니다.
              </>
            }
          />
  ...
  {pledges.map((p) => (
        ...
        <section className={SECTION_PANEL}>
          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <br />
            <strong>쓰는 법</strong> — “자산 추가”로 적어 두시면 대화에서도 그 목록을 그대로 읽어 드립니다. 대화로는 목록이 늘지 않습니다 — 정확해야 하는 값이라 화면에서만 받습니다.
              </>
            }
          />
  ...
  {assets.map((a) => (
        ...
        <section className={SECTION_PANEL}>
          <SectionHeading
            ...
            <br />
            <strong>쓰는 법</strong> — 읽기만 하는 자리입니다. 고칠 수 없게 만든 것이 이 기록의 값이라, 생각이 바뀌시면 지우는 대신 새 기록이 덧붙습니다.
              </>
            }
          />
