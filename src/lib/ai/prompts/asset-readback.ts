 ...
 *  ⚠ 예전에는 "올려 주신 서류와 직접 적어 주신 내용"이었다. 종이 업로드 화면으로 가는
 *  입구가 없어져(2026-08-03) 사용자가 서류를 올릴 길이 없으므로, 그 말은 참이 아니게 됐다.
 *  화면(AssetStatus)과 **같은 문장**을 쓴다 — 다르면 같은 재산에 두 개의 설명이 생긴다 */
const LIMIT_NOTE = "저희는 직접 적어 주신 내용까지만 알 수 있습니다.";
 ...
 * (직접 입력) 참인 문장은 **"저희가 확인한 자산이 없다"** 뿐이다.
 */
